...
This section takes a deep dive into Blocks as they make up the bulk of user interfaces in RDS. 

## Block standards

In their simplest form, RDS Blocks are grouped snippets of HTML, CSS, and sometimes JS. They are, however, guided by clear standards and a shared set of principles in order to:
