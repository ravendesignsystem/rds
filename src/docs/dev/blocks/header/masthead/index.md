...
<p>Reminder: the masthead block needs to be in the page header section. Don't forget to have and insert your Masthead code in a <code>< header ></code> tag.</p>
</div>
...
<div id="id-masthead" class="u-block u-block--full">
    <div class="b-masthead">
        <h1>
            <a href="/">
                {% verbatim %}{% include 'icons/mark-cushield.svg' %}{% endverbatim %}<span>Raven Design System<span>Raven Design System</span></span></a>
            </a>
        </h1>
    </div>
</div>
...
<a class="c-buttoncta" href="stories/long-title/">View long title example story</a>
...
<img src="http://cu-rds.s3.amazonaws.com/docs/assets/mh-login.png" alt="Masthead example with search button">
...
<a class="c-buttoncta" href="stories/login/">View search button example story</a>
...
```
<br>
<a class="c-buttoncta" href="stories/cta/">View CTA button example story</a>
