	...
	source: [
		{
			list: [
				{
					value: 'IT CCS information technology services',
					text: 'Information Technology Services (ITS)',
					url: 'https://carleton.ca/its/',
				},
				{
					value: 'admissions undergraduate future programs',
				...
				{
					value: 'co-op Co-operative Education',
					text: 'Co-operative Education',
					url: 'https://carleton.ca/co-op',
				},
				{
					value: 'cuLearn',
					text: 'cuLearn',
					url: 'https://culearn.carleton.ca',
				},
				{
					value: 'Proctoring exam services',
					text: 'Proctoring services',
					url: '//carleton.ca/proctoring-services/',
				},
				{
					value: 'giving FutureFunder donations',
					text: 'FutureFunder',
